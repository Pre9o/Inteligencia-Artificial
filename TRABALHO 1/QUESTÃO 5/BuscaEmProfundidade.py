...
class BuscaEmProfundidade:
    """
    Implementação de um algoritmo de busca em profundidade.
    """

    def __init__(self):
        """
        Inicializa a classe BuscaEmProfundidade.
        """
    ...
    def busca(self, problema):
        """
        Realiza a busca em profundidade para encontrar uma solução para o problema fornecido.
    ...
    def mostraGrafo(self):
        ...
        plt.savefig("grafo_solucao_profundidade.png")  # Salva o grafo como imagem
