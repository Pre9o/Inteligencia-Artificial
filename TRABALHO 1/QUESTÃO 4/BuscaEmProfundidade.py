...
class BuscaEmProfundidade:
    """
    Implementação de um algoritmo de busca em profundidade com visualização do grafo de solução.
    """

    def __init__(self):
        """
        Inicializa a classe de busca em profundidade.

        Fronteira é a lista de estados a serem explorados, cada elemento é uma tupla (estado, caminho).
    ...
    def mostraGrafo(self):
        ...
        plt.savefig("grafo_solucao_profundidade.png")  # Salva o grafo como uma imagem
